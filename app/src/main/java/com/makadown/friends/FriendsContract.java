...
public class FriendsContract
{
    ...
    public static String CONTENT_AUTHORITY = "com.makadown.friends.provider";
    ...
    public static class Friends implements  FriendsColumns, BaseColumns
    {
        ...
        //Más info en : http://developer.android.com/intl/es/guide/topics/providers/content-provider-creating.html
